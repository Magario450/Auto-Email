...
class MainWindow(QMainWindow):
    ...
    def SelectOutlookFolder(self):
        ...
        self.selectOutlookFolder.FillOutlookFoldersList(self)
...
class SelectOutlookFolder(QMainWindow):
    ...
    def __init__(self):
        ...
        # self.listOutlookFolders.installEventFilter(self)
        # self.listOutlookFolders.doubleClicked.connect()
    ...
    def FillOutlookFoldersList(self, main):
        self.main = main
